...
public class SmgpRequest implements com.partsoft.umsp.Request {
	
	public static final String ARG_REQUEST = "smgp.request";
	
	public static final String ARG_LOGGED = "smgp.user.logged";

	public static final String ARG_SEQUENCE = "smgp.context.sequence";

	/**
	 * @brief 已提交处理的消息列表
	 */
	public static final String ARG_SUBMIT_QUEUE = "smgp.context.submit.queue";
	...
	private SmgpDataPacket _dataPacket;

	private PacketInputStream _packetinput;

	public SmgpRequest(com.partsoft.umsp.Request request) {
		super();
		this._request = request instanceof SmgpRequest ? ((SmgpRequest) request)._request : request;
	}
	...
	protected void setDataPacket(SmgpDataPacket _dataPacket) {
		this._dataPacket = _dataPacket;
	}

	public SmgpDataPacket getDataPacket() {
		return _dataPacket;
	}
