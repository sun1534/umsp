...
public abstract class AbstractConnector extends AbstractBuffers implements Connector {
	...
	private String _protocol = PacketContextHandler.UNKOWN_CONTEXT_PROTOCOL;
	...
	// 最大socket数据读取等待时间(毫秒)，默认60秒
	protected int _maxIdleTime = 60000;
	// 处理资源低下时的数据读取等待时间(毫秒)，默认30秒
	protected int _lowResourceMaxIdleTime = 30000;
	// 关闭时等待多长时间发送数据完成返回(毫秒)，默认5秒
	protected int _soLingerTime = 5000;
