...
public class SgipResponse implements com.partsoft.umsp.Response {

	private com.partsoft.umsp.Response _proxy;

	private PacketOutputStream _datastream;

	public SgipResponse(com.partsoft.umsp.Response proxy) {
		this._proxy = proxy instanceof SgipResponse ? ((SgipResponse) proxy)._proxy : proxy;
	}
	
	protected void setWrapper(com.partsoft.umsp.Response proxy) {
		this._proxy = proxy;
	}
	...
	public void writeDataPacket(SgipDataPacket packet) throws IOException {
	...
	public void flushDataPacket(SgipDataPacket packet) throws IOException {
