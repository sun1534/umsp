...
public class View extends AbstractBuffer {
	...
	/**
	 * @param buffer
	 *            The <code>Buffer</code> on which we are presenting a
	 *            <code>View</code>.
	 * @param mark
	 *            The initial value of the {@link Buffer#markIndex mark index}
	 * @param get
	 *            The initial value of the {@link Buffer#getIndex get index}
	 * @param put
	 *            The initial value of the {@link Buffer#putIndex put index}
	 * @param access
	 *            The access level - one of the constants from {@link Buffer}.
	 */
	...
	/**
	 * @return Whether the underlying buffer is {@link Buffer#isReadOnly read
	 *         only}
	 */
	...
	/**
	 * @return Whether the underlying buffer is {@link Buffer#isVolatile
	 *         volatile}
	 */
	...
	/**
	 * @return The result of calling {@link Buffer#peek(int)} on the underlying
	 *         buffer
	 */
	...
	/**
	 * @return The result of calling {@link Buffer#peek(int, byte[], int, int)}
	...
	/**
	 * @return The result of calling {@link Buffer#peek(int, int)} on the
	 *         underlying buffer
	 */
	...
	public static class CaseInsensitive extends View implements Buffer.CaseInsensitve {
		...
		public boolean equals(Object obj) {
			return this == obj || ((obj instanceof Buffer) && ((Buffer) obj).equalsIgnoreCase(this))
					|| super.equals(obj);
		}
	}
}
