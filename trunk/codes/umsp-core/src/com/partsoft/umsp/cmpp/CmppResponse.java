...
public class CmppResponse implements com.partsoft.umsp.Response {
	...
	public CmppResponse(com.partsoft.umsp.Response proxy) {
		this._proxy = proxy instanceof CmppResponse ? ((CmppResponse) proxy)._proxy : proxy;
	}
	...
	public void writeDataPacket(CmppDataPacket packet) throws IOException {
	...
	public void flushDataPacket(CmppDataPacket packet) throws IOException {
